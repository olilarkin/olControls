...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 534.0, 290.0, 50.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 475.0, 565.0, 43.0, 20.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 287.5, 257.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 213.0, 257.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.5, 293.0, 59.0, 18.0 ],
					"text" : "vsegs $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 293.0, 59.0, 18.0 ],
					"text" : "hsegs $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 267.0, 161.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 192.0, 53.0, 18.0 ],
					"text" : "snap $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 196.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.0, 654.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 654.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 99.0, 623.0, 69.0, 20.0 ],
					"text" : "unpack f f"
				}
...
, 			{
				"box" : 				{
					...
					"restore" : [ 4, 0.266968, 0.834646, 0.420814, 0.574803, 0.565611, 0.779528, 0.696833, 0.488189 ],
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "linewidth", 1 ], [ "grgb", 0, 0, 0, 0.2 ], [ "vsegs", 3 ], [ "hsegs", 3 ], [ "frgb", 1, 0, 0, 1 ] ],
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 99.0, 348.0, 221.0, 254.0 ],
					"varname" : "jsui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 338.0, 54.0, 18.0 ],
					"text" : "recall $1"
				}
